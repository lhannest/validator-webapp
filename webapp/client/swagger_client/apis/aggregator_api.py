...
class AggregatorApi(object):
    ...
    def get_beacons_with_http_info(self, **kwargs):
        ...
        return self.api_client.call_api(resource_path, 'GET',
                                        ...
                                        response_type='list[KnowledgeBeacon]',
    ...
    def get_errors(self, session_id, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_errors(session_id, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param str session_id: session identifier  (required)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.get_errors_with_http_info(session_id, **kwargs)
        else:
            (data) = self.get_errors_with_http_info(session_id, **kwargs)
            return data

    def get_errors_with_http_info(self, session_id, **kwargs):
        """
        Get a log of the most recent errors in this session 
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_errors_with_http_info(session_id, callback=callback_function)
        ...
        if ('session_id' not in params) or (params['session_id'] is None):
            raise ValueError("Missing the required parameter `session_id` when calling `get_errors`")
