...
class SummaryApi(object):
    ...
    def linked_types(self, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.linked_types(callback=callback_function)
        ...
        if kwargs.get('callback'):
            return self.linked_types_with_http_info(**kwargs)
        else:
            (data) = self.linked_types_with_http_info(**kwargs)
            return data

    def linked_types_with_http_info(self, **kwargs):
        """
        Get a list of types and # of instances in the knowledge source, and a link to the API call for the list of equivalent terminology 
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.linked_types_with_http_info(callback=callback_function)
