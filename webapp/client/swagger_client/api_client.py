...
class ApiClient(object):
    ...
    NOTE: This class has been edited manually to expose the requesting URL
    ...
    def __call_api(self, resource_path, method,
        ...
        self.last_url_request = url + '?' + '&'.join(
            [str(k)+'='+str(v) for k, v in query_params]
        )
